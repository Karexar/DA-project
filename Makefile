...
# SANS flags
da_proc: timer.c da_proc.c random.c delivered.c socket.c log.c utils.c udp.c algo.c ack.c process.c
	gcc -Wall -std=c99 -D_POSIX_C_SOURCE=199309L -o da_proc timer.c random.c delivered.c socket.c log.c process.c ack.c algo.c udp.c utils.c da_proc.c -I.
